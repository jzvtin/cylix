        ...
        <>
          <div className="grid">
            <div className="flex flex-col">
              ...
              <span className="mb-4 text-ink/50 txt-medium">
                ...
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-4 border rounded-lg px-8 mb-2 hover:shadow-borders-interactive-with-active",
                        {
                          "border-gold-500":
                        ...
                        >
                          <div className="flex items-start gap-x-4">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-base-regular text-ink/50">
                                {formatAddress(

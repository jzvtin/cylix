 ...
 * Coded names only for regulated metabolic compounds (RT / TZ / SM / Cagri).
 *
...
export const COMPOUNDS: CompoundReference[] = [
  {
    code: "BPC-157",
    slug: "bpc-157",
    category: "Peptide reference standard",
    ...
    researchSummary:
      "BPC-157 is a synthetic pentadecapeptide reference standard derived from a gastric protein fragment. In the in-vitro literature it is characterised for its stability in aqueous solution and its interaction with cytoprotective and angiogenic signalling pathways. It is supplied here purely as an analytical reference material for laboratory characterisation work.",
    image: "bpc-157",
  ...
  },
  {
    ...
    researchSummary:
      "TB-500 is a synthetic peptide reference standard corresponding to the active region of a naturally occurring actin-binding protein. It is studied in vitro for its role in actin sequestration and cell-migration signalling models. Cylix supplies it strictly as a laboratory reference standard for analytical and research characterisation.",
    reconstitution: { vialMg: 5, bacWaterMl: 2 },
  },
  {
    code: "GHK-Cu",
    slug: "ghk-cu",
    category: "Copper-peptide reference standard",
  ...
  },
  {
    ...
    appearance: "White lyophilized powder.",
    solubility: "Soluble in sterile or bacteriostatic water; handle gently to preserve the peptide structure.",
    storage:
  ...
  },
  {
    code: "MOTS-C",
    slug: "mots-c",
    category: "Mitochondrial peptide reference standard",
    ...
    researchSummary:
      "MOTS-C is a mitochondrial-derived peptide reference standard studied in vitro for its role in metabolic-homeostasis and AMPK-related signalling models. It is characterised in the literature as a regulator of cellular energy-sensing pathways. It is supplied purely as an analytical reference material for research characterisation.",
    reconstitution: { vialMg: 10, bacWaterMl: 2 },
  },
  {
    code: "RT",
    slug: "rt",
    category: "Triple-receptor metabolic reference standard",
    ...
    researchSummary:
      "RT is a synthetic multi-agonist peptide reference standard in the triple metabolic-receptor agonist class. In vitro it is characterised as a reference material for receptor-binding and metabolic-signalling assays involving three complementary receptor targets. Cylix supplies RT strictly as an analytical reference standard for in-vitro laboratory research — it is not for human or animal use.",
    image: "rt",
    reconstitution: { vialMg: 10, bacWaterMl: 2 },
  },
  {
    code: "TZ",
    slug: "tz",
    category: "Dual-receptor metabolic reference standard",
    ...
    researchSummary:
      "TZ is a synthetic dual-agonist peptide reference standard in the dual metabolic-receptor agonist class. It is used in vitro as a reference material for receptor-binding characterisation and metabolic-signalling research across two receptor targets. Cylix supplies TZ solely as an analytical reference standard for in-vitro laboratory research.",
    image: "tz",
    reconstitution: { vialMg: 10, bacWaterMl: 2 },
  },
  {
    code: "SM",
    slug: "sm",
    category: "Single-receptor metabolic reference standard",
    ...
    storage:
      "Store lyophilized at −20 °C, protected from light and moisture. Keep reconstituted solution at 2–8 °C and limit freeze–thaw cycles.",
    researchSummary:
      "SM is a synthetic single-agonist peptide reference standard in the metabolic-receptor agonist class. In vitro it serves as a reference material for receptor-binding and metabolic-signalling assays at a single receptor target. Cylix supplies SM exclusively as an analytical reference standard for in-vitro laboratory research.",
    reconstitution: { vialMg: 5, bacWaterMl: 2 },
  },
  {
    code: "Cagri",
    ...
    appearance: "White lyophilized powder.",
    solubility: "Soluble in sterile or bacteriostatic water; handle gently to preserve the peptide.",
    storage:
      "Store lyophilized at −20 °C, desiccated and light-protected. Reconstituted solution is held at 2–8 °C.",
    researchSummary:
      "Cagri is a long-acting amylin-analogue peptide reference standard studied in vitro for its receptor-binding profile within the amylin-signalling class. It is characterised as a reference material for metabolic-signalling and receptor-affinity research. Cylix supplies Cagri as an analytical reference standard for in-vitro laboratory research only.",
    reconstitution: { vialMg: 5, bacWaterMl: 2 },
  },
  {
    code: "KLOW",
    slug: "klow",
    category: "Peptide-blend reference standard",
    appearance: "White to off-white lyophilized powder (multi-peptide blend).",
    solubility: "Soluble in sterile or bacteriostatic water; the combined peptides dissolve readily.",
    storage:
    ...
    researchSummary:
      "KLOW is a multi-peptide reference blend combining several regenerative-signalling reference standards into a single characterisation matrix. It is used in vitro as a convenience reference for laboratories studying combined matrix-remodelling and repair-signalling models. It is supplied strictly as an analytical reference material.",
    image: "klow",
  ...
  },
  {
    ...
    storage:
      "Store lyophilized at −20 °C, desiccated and light-protected. Reconstituted solution is held at 2–8 °C.",
    researchSummary:
      "Glow is a multi-peptide reference blend pairing a copper-peptide reference standard with regenerative-signalling peptides for combined in-vitro study. It is characterised as a convenience reference matrix for matrix-remodelling and extracellular-signalling research. Cylix supplies it purely as an analytical reference material.",
    image: "glow",
    reconstitution: { vialMg: 70, bacWaterMl: 5 },
  },
]
